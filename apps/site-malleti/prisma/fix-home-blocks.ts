...
async function main() {
  console.log("🔧 Fixing Home page blocks...");

  // Buscar a página Home (pode ser page-home ou outro ID)
  ...
  console.log(`📄 Found page: ${homePage.name} (${homePage.id})`);
  ...
  console.log("🎉 Home page now has 6 blocks!");
}
